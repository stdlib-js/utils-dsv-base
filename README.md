...
```javascript
base = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-dsv-base@v0.0.1-umd/browser.js' )
```
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-dsv-base@v0.0.1-umd/browser.js"></script>
```
